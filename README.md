...
- Step 3: Run Command Propmt or Power Shell as Administrator
- Step 4: Go to the file containing your server system
```python
...
pip install -e .
```
- Step 7: Repeat steps 5 and 6 with the remaining two plugins..
- Step 8: Go back your server system
- Step 9: Open your server and play!
